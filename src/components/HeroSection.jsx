    ...
    <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        <p className="text-xl md:text-2xl text-zinc-300 mb-8">
          Premium Quality Clothing for Boys & Girls
        </p>
        <button 
          onClick={() => scrollToSection('boys-full')} 
          className="bg-yellow-500 text-black px-8 py-4 rounded-lg text-lg font-semibold hover:bg-yellow-400 transition-all duration-300 inline-flex items-center gap-2"
        >
          Shop Now <ChevronRight size={20} />
        </button>
      </div>
